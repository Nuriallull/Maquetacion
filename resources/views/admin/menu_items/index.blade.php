            ...
            <div class="one-column">
                <div class="form-group">
                    <div class="form-label">
                        <label>
                            Pulse <button class="menu-item-create" data-url="{{route('menus_item_create')}}" data-menu="{{$menu->id}}" data-language="{{$localization->alias}}">aquí</button> para añadir un nuevo elemento al menu.
                        </label>
                    </div>
                </div>
            </div>
